...
import static ee.mboysan.signverify.tree.ITreeTestUtils.assertEventValid;
...
import static ee.mboysan.signverify.util.TestUtils.flatten;
...
public class HashTreeAggregatorTest {
    ...
    public void testAggregateNullEvents() throws Exception {
        try(HashTreeAggregator aggr = new HashTreeAggregator()) {
            ...
            aggr.endAggregation();
            fail("Should have failed creating the ee.mboysan.signverify.tree!");
        } catch (Exception e) {
